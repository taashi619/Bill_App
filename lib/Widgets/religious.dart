...
class Reli extends StatefulWidget {
  @override
  _Reli createState() => _Reli();
}
class _Reli extends State<Reli> with SingleTickerProviderStateMixin {
                ...
                children: [
                  ElevatedButton(
                    ...
                    if (dkey.currentState.validate()) {
                      ...
                      // calculatedomestic(
                      //     pm, cm, selectedDate, selectedDate2);
                    }
                  }),
                ],
              ),
